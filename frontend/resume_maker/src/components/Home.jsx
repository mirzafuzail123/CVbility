        ...
        <>
            ...
            <div className='mt-16 '>
                ...
                <div className='text-center'>
                    ...
                    <p className='my-5 text-[16px] text-[#262A37]'>Choose one of free resume templates and build your resume. Create and download your professional <br /> resume in less than 5 minutes.</p>
                    <Link to='mydocument'><button className='px-4 py-2 text-white border border-primary bg-primary rounded-lg shadow hover:bg-white hover:border-primary hover:text-primary'>Create my Resume</button></Link>
                    <div className='flex justify-center mt-12  border-b-2 border-b-[#A8B0B9] h-16 w-1/2 mx-auto'>
                        ...
                        <div className={`border-b-4 border-b-primary `}>
                            <Link to='/' className='text-primary2 cursor-pointer'>Resume Templates</Link>
                        </div>

                        <Link to='/cv' className='text-[#A8B0B9] mx-8 cursor-pointer'>CV Templates</Link>
