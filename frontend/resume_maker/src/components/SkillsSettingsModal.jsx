        ...
        <div className='ml-5 my-5' ref={SkillsSettingsModalRef}>
            <div className='flex flex-col my-5 mx-5'>
                ...
                <div className='flex ml-12 space-x-5 bg-[#FBFCFF] w-72 h-10'>
                    ...
                    <button className={`${InfoGraphic === 'InfoGraphic' ? 'text-white' : 'text-[#A8B0B9]'}  ${InfoGraphic === 'InfoGraphic' ? 'bg-primary' : null} py-2 px-2 text-sm rounded-md`} onClick={() => setInfoGraphic('InfoGraphic')}>Infographic</button>
                </div>

                {InfoGraphic === 'Highlighted' && <div className={`flex my-10 space-x-3 `}>
                    <input type="checkbox" id='Intensify' checked={Intensify} className='cursor-pointer' onClick={() => Intensify ? setIntensify(false) : setIntensify(true)} />
                ...
                {InfoGraphic === 'InfoGraphic' && <div className='flex mt-10'>
                    ...
                    <div className='flex flex-col w-[30%]'>
                        ...
                        <div className='flex my-4 space-x-4 cursor-pointer' onClick={() => setSkillsSettingInfoGraphic('Free1')}>
