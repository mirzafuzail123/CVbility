    ...
    return (
        <div className='mt-16'>
            <div className='text-center'>
                ...
                <Link to='/mydocument'><button className='px-4 py-2 text-white border border-primary bg-primary rounded-lg shadow hover:bg-white hover:border-primary hover:text-primary'>Create my CV</button></Link>
